...
<head>
    ...
    <script type="text/javascript" src="<%=webPath %>/static/js/biz/operator/operator-admin.js"></script>
</head>
<body navId="1">
<!---------------------------------导航栏 开始--------------------------------------------->
...
<div class="container"
    ...
    <jsp:include page="/page/pageNavigation.jsp" flush="true">
        ...
        <jsp:param name="mainTitle" value="用户管理"/>
    </jsp:include>
    <div class="row clearfix funcNav">
        <div class="col-md-12 column">
            ...
            <div class="row">
                ...
                <div class="col-lg-3" style="width:100px;float: left">
                    <button class="btn btn-primary " type="button" name="addCertButton" onclick="showAddUserUI();">新增
                    </button>
                </div>
                <!--搜索框-->
                <div class="col-lg-5" style="width:550px">
                    <div class="input-group">
                        <input type="text" class="form-control" name="searchKey" id="searchKey" value=""
                               style="color: #787878;width: 470px \9">
    ...
    <!--表格展示div 开始-->
    <div id="gridbox" style="width:1000px;height: 430px;border:solid 0px  rgb(48, 153, 188);;margin-top: 10px"></div>
    <!--表格展示div 结束-->
